...
SELECT
    ...
    parseDateTime64BestEffort(JSONExtract(all, 'payload', 'duedate', 'Nullable(String)')) AS duedate,
    ...
    parseDateTime64BestEffort(JSONExtract(all, 'payload', 'order_date', 'Nullable(String)')) AS order_date,
    ...
    parseDateTime64BestEffort(JSONExtract(all, 'payload', 'shipdate', 'Nullable(String)')) AS shipdate,
